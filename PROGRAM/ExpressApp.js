...
const db_name = path.join(__dirname, "vkr_database.db");
...
// Starting the server
app.listen(8000, () => console.log(`Express server listening on port 3000`));
