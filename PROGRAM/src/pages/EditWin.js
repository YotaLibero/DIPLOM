...
export class EditWin extends React.Component {
                            ...
                            <div id="frame01">
                                ...
                                >
                                    <div id="modryad">
                                        <div id="frame030">
                                            <ul>
                                                <label htmlFor="dat_file"
                                                    ...
                                                    <input type="file"
                                                           accept=".dat" id="dat_file" multiple="multiple"
                                                           onChange={() => {
                                        ...
                                        <Button className="closing-button-cl"
                                                onClick={this.handleSubmit}><span>Сформировать</span></Button>
                                    </div>
                                </Parser>
