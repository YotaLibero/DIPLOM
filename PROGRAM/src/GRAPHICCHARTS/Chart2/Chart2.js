...
// ]
//
// const getAxisYDomain1 = (from, to, ref, offset) => {
//     const refData = data1.slice(from - 1, to);
//     let [bottom, top] = [refData[0][ref], refData[0][ref]];
//     refData.forEach(d => {
//         if (d[ref] > top) top = d[ref];
//         if (d[ref] < bottom) bottom = d[ref];
...
//
//     zoom1() {
//         let { refAreaLeft1, refAreaRight1, data1 } = this.state;
//
//         if (refAreaLeft1 === refAreaRight1 || refAreaRight1 === "") {
//             this.setState(() => ({
//                 refAreaLeft1: "",
//                 refAreaRight1: ""
//             }));
...
//
//         // xAxis domain
//         if (refAreaLeft1 > refAreaRight1)
//             [refAreaLeft1, refAreaRight1] = [refAreaRight1, refAreaLeft1];
//
//         // yAxis domain
//         const [bottom, top] = getAxisYDomain1(refAreaLeft1, refAreaRight1, "cost", 2);
//         const [bottom2, top2] = getAxisYDomain1(
//             refAreaLeft1,
//             refAreaRight1,
//             "impression",
//             50
...
//
//         return (
//             <div className="highlight-bar-chart">
//                 <button className="btn update" onClick={this.zoomOut1.bind(this)}>
//                     Вернуться
//                 </button>
//                 <LineChart
//                     width={670}
...
//                     data={data1}
//                     margin={{ top: 5, right: 20, left: -5, bottom: 15 }}
//                     onMouseDown={e => this.setState({ refAreaLeft1: e.activeLabel })}
//                     onMouseMove={e =>
//                         this.state.refAreaLeft1 &&
//                         this.setState({ refAreaRight1: e.activeLabel })
//                     }
//                     onMouseUp={this.zoom1.bind(this)} >
//                     <CartesianGrid strokeDasharray="3 3" />
//                     <XAxis
//                         allowDataOverflow={true}
//                         dataKey="name"
