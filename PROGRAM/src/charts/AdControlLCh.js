...
//
// export default function LineChart0() {
...
//                     (d) => d.name >= x1 && d.name <= x2 && d.Y_1 >= y1 && d.Y_1 <= y2
//                 );
...
//                     />
//                 )}
//                 <Line data={filteredData} type="monotone" dataKey="Y_1" stroke="#8D0101" strokeWidth={2} dot={false} />
//             </LineChart>
//         </div>
//     );
// }
...
class AdControlLCh extends React.Component {
    render() {
        ...
        return (
            <div className="highlight-bar-charts">
                <LineChart
                    ...
                    <Tooltip />
                    {/*<Legend />*/}
                    <Line type="monotone" dataKey="Y_1" stroke="#027ED9" strokeWidth={2} dot={false} />
                    <Line type="monotone" dataKey="Y_2" stroke="#006149" strokeWidth={2} dot={false} />
                    <Line type="monotone" dataKey="Y_3" stroke="#D99D02" strokeWidth={2} dot={false} />
...
export default connect(mapStateToProps, mapDispatchToProps)(AdControlLCh);